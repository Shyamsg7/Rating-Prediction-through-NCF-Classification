...
class NeuMF(torch.nn.Module):
    def __init__(self, config):
        ...
        #specifies the number of unique embeddings in the dictionary, and the size of each embedding vector
    ...
    #HAVE TO CHANGE THIS FOR CLASSIFICATION
        ...
        self.affine_output = torch.nn.Linear(in_features=config['layers'][-1] + config['latent_dim_mf'], out_features=5)
